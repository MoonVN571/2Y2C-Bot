...
function createBot() {
	...
	const DeathftNotifyEvent = require(`./events-ingame/msg.js`);
	...
	bot.on('message', msg => {
		...
		if(logger.includes("2y2c") && logger.includes('pvp') && !logger.includes(".ga")) {
			bot.whisper(username, "> Server IP: 2y2cpvp.ga.");
		}
